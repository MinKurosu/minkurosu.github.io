 const skins = [
        ...
        {
            id: 'skin_viewer_alex',
            url: 'https://files.catbox.moe/uknvlp.png' // Alex
        },
        {
    ...
    skins.forEach(skinData => {
        ...
        if (canvasElement) {
            const skinViewer = new skinview3d.FXAASkinViewer({
                ...
                width: 200, // Largura do canvas, pode ser ajustada
                height: 300, // Altura do canvas, pode ser ajustada
                skin: skinData.url
            });

            // Opcional: Animações e controles para o skinview3d
